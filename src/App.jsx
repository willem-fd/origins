...
function GrowersPage({ growers, setGrowers, products }) {
  ...
  const filtered = growers.filter(g => !search ||
    ...
    <>
      ...
      <div className="card">
        <div className="card-header">
          ...
          <button className="btn btn-primary" onClick={() => setShowNew(true)}><i className="ti ti-plus" /> Add grower</button>
        </div>
        <div className="table-wrap">
          <table>
      ...
      {showNew && (
        <div className="modal-overlay" onClick={e => e.target === e.currentTarget && setShowNew(false)}>
          <div className="modal" style={{ maxWidth: 520 }}>
            <div className="modal-header">
              <i className="ti ti-plant" style={{ fontSize: 17, color: 'var(--green)' }} />
...
function LogisticsPage({ logistics, setLogistics }) {
  ...
  const validate = () => {
    ...
    if (!validateEmail(f.contact_email)) e.contact_email = 'Invalid email'
    if (!validatePhone(f.contact_phone)) e.contact_phone = 'Invalid phone'
    setErrors(e); return Object.keys(e).length === 0
  }
    ...
    <>
      <div className="card">
        <div className="card-header">
          ...
          <button className="btn btn-primary" onClick={() => setShowNew(true)}><i className="ti ti-plus" /> Add partner</button>
        </div>
        <div className="table-wrap">
          <table>
      ...
      {showNew && (
        <div className="modal-overlay" onClick={e => e.target === e.currentTarget && setShowNew(false)}>
          <div className="modal" style={{ maxWidth: 520 }}>
            <div className="modal-header">
              <i className="ti ti-truck" style={{ fontSize: 17, color: 'var(--green)' }} />
            ...
            <div className="modal-body">
              <div className="form-row">
                <div className="form-group" style={{ flex: 2 }}>
                  ...
                  <input className={`form-input${errors.name ? ' error' : ''}`} value={f.name} onChange={e => set('name', e.target.value)} />
                  {errors.name && <div className="form-error">{errors.name}</div>}
                </div>
                <div className="form-group">
                  <label className="form-label">Code</label>
